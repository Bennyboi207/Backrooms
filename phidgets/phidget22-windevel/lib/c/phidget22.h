...
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getMinDataInterval		(PhidgetHandle phid, uint32_t *min);
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getMaxDataInterval		(PhidgetHandle phid, uint32_t *max);
...
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getMinDataRate			(PhidgetHandle phid, double *min);
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getMaxDataRate			(PhidgetHandle phid, double *max);
...
/* Generated by WriteClassHeaderVisitor: Thu May 19 2022 10:08:56 GMT-0600 (Mountain Daylight Time) */
...
/* Properties */
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetLCD_setAutoFlush(PhidgetLCDHandle ch, int autoFlush);
__declspec(dllimport) PhidgetReturnCode __stdcall PhidgetLCD_getAutoFlush(PhidgetLCDHandle ch, int *autoFlush);
